...
interface MovieProfileListener {
    fun showDetails(id: Int)
    fun bookmarkAction(id: Int, category:CategoryType)
    fun showInfo(id: Int)
}
...
fun MovieProfile(
    ...
    ConstraintLayout(
        ...
        Image(
            ...
            modifier = Modifier
                .size(30.dp)
                .clickable { listener?.bookmarkAction(id, category) }
...
fun MovieProfilePreview() {
    TrailerxTheme {
        MovieProfile(
            ...
            listener = null,
            category = CategoryType.WATCH_LIST_MOVIES
        )
    }
}
...
fun MovieProfilePreviewNight() {
    TrailerxTheme {
        MovieProfile(
            ...
            imageUrl = "",
            listener = null,
            category = CategoryType.HISTORY_MOVIES
        )
    }
}